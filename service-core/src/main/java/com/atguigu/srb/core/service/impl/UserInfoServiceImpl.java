...
public class UserInfoServiceImpl extends ServiceImpl<UserInfoMapper, UserInfo> implements UserInfoService {
    ...
    public void register(RegisterVO registerVO) {
        ...
        //设置一张静态资源服务器上的头像图片
        userInfo.setHeadImg("https://srb-file-7.oss-cn-hangzhou.aliyuncs.com/portrait/d0c8a786c9177f3ea4338a61269a5bc19f3d5636.jpeg");
    ...
    public IPage<UserInfo> listPage(Page<UserInfo> pageParam, UserInfoQuery userInfoQuery) {
        ...
        userInfoQueryWrapper.eq(StringUtils.isNotBlank(mobile), "mobile", mobile).eq(status != null, "status", userInfoQuery.getStatus()).eq(userType != null, "user_type", userType);
